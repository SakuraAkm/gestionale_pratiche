...
<main>
    ...
    <section class="min-height d-flex justify-content-center align-items-center mx-auto">
        <form action="aggiungi_pratica.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="responsive-form container position-relative py-5 d-flex justify-content-center align-items-center">
                <div>
                    <div class="mb-3">
                        <label for="emailUtente" class="form-label">Email Utente</label>
                        <input type="email" class="form-control" id="emailUtente" placeholder="Email@gestionale.it" name="emailUtente" 
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="corso" placeholder="Nome del Corso" name="corso" 
